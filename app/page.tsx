...
const THEMES: BoardTheme[] = [
  ...
  { id: "midnight", name: "Midnight", description: "Sleek dark workspace", dark: true, colors: { ink: "#e7e9ee", muted: "#9aa3af", line: "#2a2f3c", paper: "#12151c", sidebar: "#171b26", white: "#1d2230", blue: "#7c93f2", orange: "#f0ac74", pink: "#ec93ab", green: "#7bc79f", accent: "#f0996f", "accent-strong": "#5d79ec", "on-accent": "#ffffff", "surface-muted": "#242a3a" } },
